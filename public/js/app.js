...
},{"../models/team":9,"backbone":7}],2:[function(require,module,exports){
...
teamsCollection.fetched = teamsCollection.fetch().done;

module.exports = teamsCollection;


},{"../../collections/teams":1}],3:[function(require,module,exports){
var Backbone, _;
...
Backbone = require('../components/backbone/backbone');
...
},{"../components/backbone/backbone":4,"jquery":5}],8:[function(require,module,exports){
var Backbone, React, events, router;
...
},{"./router":11,"backbone":7,"events":3,"react":6}],9:[function(require,module,exports){
...
var Backbone, React, Router, TeamView, TeamsListView, appContainer, render;
...
Router = Backbone.Router.extend({
  ...
  index: function() {
    return render(TeamsListView(), appContainer);
  },
  team: function(id) {
...
},{"./views/team":13,"./views/teams_list":15,"backbone":7,"react":6}],12:[function(require,module,exports){
var events;
...
},{"events":3}],13:[function(require,module,exports){
var React, Team, TeamModel, div, events, teamsCollection;
...
Team = React.createClass({
  ...
  componentDidMount: function() {
    var _this = this;
    return teamsCollection.fetched(function() {
      _this.state.team = teamsCollection.get(_this.props.id);
      return _this.update();
    });
  },
  render: function() {
    return div({
      className: "team " + (this.state.team.get('id'))
...
},{"../instances/collections/teams":2,"../models/team":9,"events":3,"react":6}],14:[function(require,module,exports){
...
TeamItem = React.createClass({
  ...
  url: function() {
    return "joukkueet/" + (this.props.get('id'));
  },
  render: function() {
    return div({
      className: "team " + (this.props.get('id')),
...
},{"./mixins/navigate":12,"react":6}],15:[function(require,module,exports){
var React, TeamItem, TeamsList, div, teamsCollection;
...
TeamsList = React.createClass({
  ...
  componentDidMount: function() {
    return this.state.teams.fetched(this.update);
  },
  componentWillUnmount: function() {},
  render: function() {
    return div({
      className: "teams_view"
    }, this.state.teams.map(TeamItem));
  }
});
...
},{"../instances/collections/teams":2,"./team_item":14,"react":6}]},{},[8])
;